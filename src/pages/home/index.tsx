...
function Home(props:any) {
  ...
  return (
    <div className='Home-flex Home-flex1'>
      {/* {homeHead()} */}
      <Head showSearch={false} />
      {/* {searchBody()} */}
      <div className='Home-flex Home-flex1' style={{alignItems:'center'}}>
        <p className='Home-title'>Search Trends</p>
        <Search className='Home-search-body'  />
      </div>
    </div>
  );
}
